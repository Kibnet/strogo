...
Trusted positive corpus — 12 случаев, включающий baseline, accepted/rejected Reserve branches, I64 boundary values, checked overflow in selected/unselected branch, bool `Select`, `bool.not`, strict `and/or` и deterministic declaration-order pair. Отдельный negative suite должен различать malformed graph, typed notation refusal, correct refusal и infrastructure failure; один случай не получает скрытый repair answer.
