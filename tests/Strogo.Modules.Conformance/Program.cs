...
try
{
    ...
    Check(RejectFold("fold-prefix-unknown-op", (_, _, fold) => fold["invariant"]!["args"]![0]!["args"]![1]!["op"] = "seq.prefix_sum_i65").Code == "UnsupportedProofOpcode", "fold proof rejects an unknown prefix operation");
    Check(RejectFold("fold-bound-out-of-scope", (_, _, fold) => fold["invariant"] = JsonNode.Parse("{\"op\":\"eq\",\"type\":\"Bool\",\"args\":[{\"op\":\"proof.bound\",\"type\":\"I64\",\"binderId\":\"i\"},{\"op\":\"i64.const\",\"type\":\"I64\",\"value\":\"0\"}]}")).Code == "UnknownProofBinder", "proof bound cannot escape its forall.sequence scope");
