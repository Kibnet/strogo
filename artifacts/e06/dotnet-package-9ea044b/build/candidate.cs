// Dafny program candidate.dfy compiled into C#
...
// Command-line arguments: translate cs candidate.dfy --no-verify --enforce-determinism --include-runtime --output Candidate.cs --translation-record-output translation-record.dtr
// candidate.dfy


module Candidate {
  function StrictAnd(left: bool, right: bool): bool
  ...
  function StrictOr(left: bool, right: bool): bool
    decreases left, right
  {
    left || right
  }
  ...
  lemma /*{:_inductionTrigger SumI64(s)}*/ /*{:_inductionTrigger |s|}*/ /*{:_induction s}*/ PrefixSumWhole(s: seq<I64>)
  ...
  lemma /*{:_inductionTrigger SumI64(s)}*/ /*{:_inductionTrigger |s|}*/ /*{:_induction s}*/ SumNonnegative(s: seq<I64>)
    requires forall j: int {:trigger s[j]} :: 0 <= j < |s| ==> 0 <= s[j]
    ensures 0 <= SumI64(s)
    decreases |s|
  {
    if |s| > 0 {
      SumNonnegative(s[..|s| - 1]);
    }
  }

  lemma /*{:_inductionTrigger SumI64(s)}*/ /*{:_inductionTrigger PrefixSumI64(s, n)}*/ /*{:_inductionTrigger |s|}*/ /*{:_induction s}*/ PrefixSumBounds(s: seq<I64>, n: int)
    requires 0 <= n <= |s|
    requires forall j: int {:trigger s[j]} :: 0 <= j < |s| ==> 0 <= s[j]
  ...
  predicate Q004(p000: S001)
    decreases p000
  {
    forall q000: int {:trigger p000[q000]} :: 
      0 <= q000 < |p000| ==>
        StrictAnd(-1000000 <= p000[q000], p000[q000] <= 1000000)
  }

  function P004(p000: S001, n: int): R000
    requires Q004(p000) && 0 <= n <= |p000|
    ensures StrictAnd(|P004(p000, n).R000F000| as I64 == n as I64, StrictAnd(0 - (if n as I64 <= 0 then 0 else if n as I64 <= 1 then 1000000 else if n as I64 <= 2 then 2000000 else if n as I64 <= 3 then 3000000 else if n as I64 <= 4 then 4000000 else if n as I64 <= 5 then 5000000 else if n as I64 <= 6 then 6000000 else if n as I64 <= 7 then 7000000 else 8000000) <= P004(p000, n).R000F002, StrictAnd(P004(p000, n).R000F002 <= if n as I64 <= 0 then 0 else if n as I64 <= 1 then 1000000 else if n as I64 <= 2 then 2000000 else if n as I64 <= 3 then 3000000 else if n as I64 <= 4 then 4000000 else if n as I64 <= 5 then 5000000 else if n as I64 <= 6 then 6000000 else if n as I64 <= 7 then 7000000 else 8000000, StrictAnd(0 <= P004(p000, n).R000F001, P004(p000, n).R000F001 <= n as I64))))
    decreases n
  {
    if n == 0 then
      C000([], 0, 0)
    else
      C000(P004(p000, n - 1).R000F000 + [p000[n - 1]], var e001: I64 := P004(p000, n - 1).R000F001 + if !(0 <= p000[n - 1]) then 1 else 0; e001, var e000: I64 := P004(p000, n - 1).R000F002 + p000[n - 1]; e000)
  }

  lemma /*{:_inductionTrigger P004(p000, n)}*/ /*{:_induction p000, n}*/ L004(p000: S001, n: int)
    requires Q004(p000) && 0 <= n <= |p000|
    ensures StrictAnd(|P004(p000, n).R000F000| as I64 == n as I64, StrictAnd(0 - (if n as I64 <= 0 then 0 else if n as I64 <= 1 then 1000000 else if n as I64 <= 2 then 2000000 else if n as I64 <= 3 then 3000000 else if n as I64 <= 4 then 4000000 else if n as I64 <= 5 then 5000000 else if n as I64 <= 6 then 6000000 else if n as I64 <= 7 then 7000000 else 8000000) <= P004(p000, n).R000F002, StrictAnd(P004(p000, n).R000F002 <= if n as I64 <= 0 then 0 else if n as I64 <= 1 then 1000000 else if n as I64 <= 2 then 2000000 else if n as I64 <= 3 then 3000000 else if n as I64 <= 4 then 4000000 else if n as I64 <= 5 then 5000000 else if n as I64 <= 6 then 6000000 else if n as I64 <= 7 then 7000000 else 8000000, StrictAnd(0 <= P004(p000, n).R000F001, P004(p000, n).R000F001 <= n as I64))))
    decreases n
  {
    if n == 0 {
      assert StrictAnd(|P004(p000, 0).R000F000| as I64 == 0 as I64, StrictAnd(0 - (if 0 as I64 <= 0 then 0 else if 0 as I64 <= 1 then 1000000 else if 0 as I64 <= 2 then 2000000 else if 0 as I64 <= 3 then 3000000 else if 0 as I64 <= 4 then 4000000 else if 0 as I64 <= 5 then 5000000 else if 0 as I64 <= 6 then 6000000 else if 0 as I64 <= 7 then 7000000 else 8000000) <= P004(p000, 0).R000F002, StrictAnd(P004(p000, 0).R000F002 <= if 0 as I64 <= 0 then 0 else if 0 as I64 <= 1 then 1000000 else if 0 as I64 <= 2 then 2000000 else if 0 as I64 <= 3 then 3000000 else if 0 as I64 <= 4 then 4000000 else if 0 as I64 <= 5 then 5000000 else if 0 as I64 <= 6 then 6000000 else if 0 as I64 <= 7 then 7000000 else 8000000, StrictAnd(0 <= P004(p000, 0).R000F001, P004(p000, 0).R000F001 <= 0 as I64))));
    } else {
      L004(p000, n - 1);
      assert StrictAnd(|P004(p000, n).R000F000| as I64 == n as I64, StrictAnd(0 - (if n as I64 <= 0 then 0 else if n as I64 <= 1 then 1000000 else if n as I64 <= 2 then 2000000 else if n as I64 <= 3 then 3000000 else if n as I64 <= 4 then 4000000 else if n as I64 <= 5 then 5000000 else if n as I64 <= 6 then 6000000 else if n as I64 <= 7 then 7000000 else 8000000) <= P004(p000, n).R000F002, StrictAnd(P004(p000, n).R000F002 <= if n as I64 <= 0 then 0 else if n as I64 <= 1 then 1000000 else if n as I64 <= 2 then 2000000 else if n as I64 <= 3 then 3000000 else if n as I64 <= 4 then 4000000 else if n as I64 <= 5 then 5000000 else if n as I64 <= 6 then 6000000 else if n as I64 <= 7 then 7000000 else 8000000, StrictAnd(0 <= P004(p000, n).R000F001, P004(p000, n).R000F001 <= n as I64))));
    }
  }
    ...
    decreases p000
  {
    ...
    while i004 < |p000|
      ...
      invariant StrictAnd(|v004.R000F000| as I64 == i004 as I64, StrictAnd(0 - (if i004 as I64 <= 0 then 0 else if i004 as I64 <= 1 then 1000000 else if i004 as I64 <= 2 then 2000000 else if i004 as I64 <= 3 then 3000000 else if i004 as I64 <= 4 then 4000000 else if i004 as I64 <= 5 then 5000000 else if i004 as I64 <= 6 then 6000000 else if i004 as I64 <= 7 then 7000000 else 8000000) <= v004.R000F002, StrictAnd(v004.R000F002 <= if i004 as I64 <= 0 then 0 else if i004 as I64 <= 1 then 1000000 else if i004 as I64 <= 2 then 2000000 else if i004 as I64 <= 3 then 3000000 else if i004 as I64 <= 4 then 4000000 else if i004 as I64 <= 5 then 5000000 else if i004 as I64 <= 6 then 6000000 else if i004 as I64 <= 7 then 7000000 else 8000000, StrictAnd(0 <= v004.R000F001, v004.R000F001 <= i004 as I64))))
      decreases |p000| - i004
    {
  ...
  newtype {:nativeType ""long""} I64 = x: int
...
module PortableWrapper {
  ...
  {
    value.WI64? &&
    -9223372036854775808 <= value.i64Value <= 9223372036854775807
  }
  ...
  predicate IsI64Sequence(value: WireValue, capacity: nat)
    decreases value, capacity
  {
    value.WSeq? &&
    |value.sequenceItems| <= capacity &&
    forall index: int {:trigger value.sequenceItems[index]} :: 
      0 <= index < |value.sequenceItems| ==>
        IsI64(value.sequenceItems[index])
  }

  function ToI64Sequence(items: seq<WireValue>): seq<I64>
    requires forall index: int {:trigger items[index]} :: 0 <= index < |items| ==> IsI64(items[index])
    ...
    decreases |items|
  {
    if |items| == 0 then
      ...
      [ToI64(items[0])] + ToI64Sequence(items[1..])
  }

  function FromI64Sequence(items: seq<I64>): WireValue
    decreases items
  {
    WSeq(seq(|items|, (index: int) requires 0 <= index < |items| => WI64(items[index] as int)))
  }

  function SequenceMismatchLocus(value: WireValue, capacity: nat, locus: string): string
    requires !IsI64Sequence(value, capacity)
    decreases value, capacity, locus
  {
    if !value.WSeq? || |value.sequenceItems| > capacity then
      locus
    else if |value.sequenceItems| > 0 && !IsI64(value.sequenceItems[0]) then
      locus + ""/items/0""
    else if |value.sequenceItems| > 1 && !IsI64(value.sequenceItems[1]) then
      locus + ""/items/1""
    else if |value.sequenceItems| > 2 && !IsI64(value.sequenceItems[2]) then
      locus + ""/items/2""
    else if |value.sequenceItems| > 3 && !IsI64(value.sequenceItems[3]) then
      locus + ""/items/3""
    else if |value.sequenceItems| > 4 && !IsI64(value.sequenceItems[4]) then
      locus + ""/items/4""
    else if |value.sequenceItems| > 5 && !IsI64(value.sequenceItems[5]) then
      locus + ""/items/5""
    else if |value.sequenceItems| > 6 && !IsI64(value.sequenceItems[6]) then
      locus + ""/items/6""
    else if |value.sequenceItems| > 7 && !IsI64(value.sequenceItems[7]) then
      locus + ""/items/7""
    else
      locus
  }
  ...
  {
    value.WRecord? &&
    value.recordTypeId == ""Summary"" &&
    |value.recordFields| == 3 &&
    value.recordFields[0].fieldId == ""echo"" &&
    IsI64Sequence(value.recordFields[0].fieldValue, 8) &&
    value.recordFields[1].fieldId == ""negativeCount"" &&
    IsI64(value.recordFields[1].fieldValue) &&
    value.recordFields[2].fieldId == ""sum"" &&
    IsI64(value.recordFields[2].fieldValue)
  }

  function SummaryMismatchLocus(value: WireValue, locus: string): string
    requires !IsSummary(value)
    decreases value, locus
  {
    if !value.WRecord? || value.recordTypeId != ""Summary"" || |value.recordFields| != 3 then
      locus
    else if value.recordFields[0].fieldId != ""echo"" then
      locus
    else if !IsI64Sequence(value.recordFields[0].fieldValue, 8) then
      SequenceMismatchLocus(value.recordFields[0].fieldValue, 8, locus + ""/fields/0/value"")
    else if value.recordFields[1].fieldId != ""negativeCount"" then
      locus
    else if !IsI64(value.recordFields[1].fieldValue) then
      locus + ""/fields/1/value""
    else if value.recordFields[2].fieldId != ""sum"" then
      locus
    else if !IsI64(value.recordFields[2].fieldValue) then
      locus + ""/fields/2/value""
    else
      locus
  }
  ...
  function ToSummary(value: WireValue): R000
    ...
    decreases value
  {
    C000(ToI64Sequence(value.recordFields[0].fieldValue.sequenceItems), ToI64(value.recordFields[1].fieldValue), ToI64(value.recordFields[2].fieldValue))
  }

  function FromSummary(value: R000): WireValue
    decreases value
  {
    WRecord(""Summary"", [WireField(""echo"", FromI64Sequence(value.R000F000)), WireField(""negativeCount"", WI64(value.R000F001 as int)), WireField(""sum"", WI64(value.R000F002 as int))])
  }

  function ArityRefusal(expected: nat, actual: nat): WireOutcome
    decreases expected, actual
  {
  ...
  method Invoke(functionId: string, arguments: seq<WireValue>) returns (outcome: WireOutcome)
    requires true
    decreases functionId, arguments
  {
...
namespace Candidate {
  ...
  public partial class __default {
    public static bool StrictAnd(bool left, bool right)
    {
      return (left) && (right);
    }
    public static bool StrictOr(bool left, bool right)
    {
      return (left) || (right);
    }
    public static BigInteger SumI64(Dafny.ISequence<long> s) {
      BigInteger _0___accumulator = BigInteger.Zero;
    TAIL_CALL_START: ;
      if ((new BigInteger((s).Count)).Sign == 0) {
        return (BigInteger.Zero) + (_0___accumulator);
      } else {
        _0___accumulator = (new BigInteger((s).Select((new BigInteger((s).Count)) - (BigInteger.One)))) + (_0___accumulator);
        Dafny.ISequence<long> _in0 = (s).Take((new BigInteger((s).Count)) - (BigInteger.One));
        s = _in0;
        goto TAIL_CALL_START;
      }
    }
    public static BigInteger PrefixSumI64(Dafny.ISequence<long> s, BigInteger n)
    {
      return Candidate.__default.SumI64((s).Take(n));
    }
    public static bool Q000(bool p000, long p001)
    {
      return Candidate.__default.StrictOr(!(p000), (p001) <= (9223372036854775806L));
    }
    public static long M000(bool p000, long p001)
    {
      if (p000) {
        long _0_e000 = (p001) + (1L);
        return _0_e000;
      } else {
        return p001;
      }
    }
    public static bool Q001(Candidate._IR000 p000) {
      return true;
    }
    public static Candidate._IR000 M001(Candidate._IR000 p000) {
      return p000;
    }
    public static bool Q002(Dafny.ISequence<long> p000) {
      return true;
    }
    public static long M002(Dafny.ISequence<long> p000) {
      if (((long)(p000).LongCount) == (0L)) {
        return 0L;
      } else {
        return (p000).Select(BigInteger.Zero);
      }
    }
    public static bool Q003(long p000) {
      return (p000) <= (9223372036854775806L);
    }
    public static long M003(long p000) {
      long _0_e000 = (p000) + (1L);
      return _0_e000;
    }
    public static bool Q004(Dafny.ISequence<long> p000) {
      return Dafny.Helpers.Id<Func<Dafny.ISequence<long>, bool>>((_0_p000) => Dafny.Helpers.Quantifier<BigInteger>(Dafny.Helpers.IntegerRange(BigInteger.Zero, new BigInteger((_0_p000).Count)), true, (((_forall_var_0) => {
        BigInteger _1_q000 = (BigInteger)_forall_var_0;
        return !(((_1_q000).Sign != -1) && ((_1_q000) < (new BigInteger((_0_p000).Count)))) || (Candidate.__default.StrictAnd((-1000000L) <= ((_0_p000).Select(_1_q000)), ((_0_p000).Select(_1_q000)) <= (1000000L)));
      }))))(p000);
    }
    public static Candidate._IR000 P004(Dafny.ISequence<long> p000, BigInteger n)
    {
      if ((n).Sign == 0) {
        return Candidate.R000.create(Dafny.Sequence<long>.FromElements(), 0L, 0L);
      } else {
        return Candidate.R000.create(Dafny.Sequence<long>.Concat((Candidate.__default.P004(p000, (n) - (BigInteger.One))).dtor_R000F000, Dafny.Sequence<long>.FromElements((p000).Select((n) - (BigInteger.One)))), Dafny.Helpers.Let<long, long>(((Candidate.__default.P004(p000, (n) - (BigInteger.One))).dtor_R000F001) + (((!((0L) <= ((p000).Select((n) - (BigInteger.One))))) ? (1L) : (0L))), _pat_let0_0 => Dafny.Helpers.Let<long, long>(_pat_let0_0, _0_e001 => _0_e001)), Dafny.Helpers.Let<long, long>(((Candidate.__default.P004(p000, (n) - (BigInteger.One))).dtor_R000F002) + ((p000).Select((n) - (BigInteger.One))), _pat_let1_0 => Dafny.Helpers.Let<long, long>(_pat_let1_0, _1_e000 => _1_e000)));
      }
    }
    public static long F000(bool p000, long p001)
    {
      long result = Candidate.I64.Witness;
      long _0_v000 = Candidate.I64.Witness;
      if (p000) {
        long _1_v001;
        long _out0;
        _out0 = Candidate.__default.F003(p001);
        _1_v001 = _out0;
        _0_v000 = _1_v001;
      } else {
        _0_v000 = p001;
    ...
    public static Candidate._IR000 F001(Candidate._IR000 p000)
    {
      Candidate._IR000 result = Candidate.R000.Default();
      result = p000;
      return result;
    }
    public static long F002(Dafny.ISequence<long> p000)
    {
      long result = Candidate.I64.Witness;
      long _0_v000;
      _0_v000 = (long)(p000).LongCount;
      long _1_v001;
      _1_v001 = 0L;
      bool _2_v002;
      _2_v002 = (_0_v000) == (_1_v001);
      long _3_v003 = Candidate.I64.Witness;
      if (_2_v002) {
        _3_v003 = _1_v001;
      } else {
        long _4_v004;
        _4_v004 = (p000).Select(new BigInteger(_1_v001));
        _3_v003 = _4_v004;
      }
      result = _3_v003;
      return result;
    }
    public static long F003(long p000)
    {
      long result = Candidate.I64.Witness;
      long _0_v000;
      _0_v000 = 1L;
      long _1_v001;
      _1_v001 = (p000) + (_0_v000);
      result = _1_v001;
      return result;
    }
    public static Candidate._IR000 F004(Dafny.ISequence<long> p000)
    {
      Candidate._IR000 result = Candidate.R000.Default();
      Dafny.ISequence<long> _0_v000;
      _0_v000 = Dafny.Sequence<long>.FromElements();
      long _1_v001;
      _1_v001 = 0L;
      long _2_v002;
      _2_v002 = 0L;
      Candidate._IR000 _3_v003;
      _3_v003 = Candidate.R000.create(_0_v000, _1_v001, _2_v002);
      Candidate._IR000 _4_v004;
      _4_v004 = _3_v003;
      BigInteger _5_i004;
      _5_i004 = BigInteger.Zero;
      while ((_5_i004) < (new BigInteger((p000).Count))) {
        Dafny.ISequence<long> _6_v005;
        _6_v005 = (_4_v004).dtor_R000F000;
        long _7_v006;
        _7_v006 = (_4_v004).dtor_R000F001;
        long _8_v007;
        _8_v007 = (_4_v004).dtor_R000F002;
        Dafny.ISequence<long> _9_v008;
        ...
        _11_v010 = 0L;
        bool _12_v011;
        _12_v011 = (_11_v010) <= ((p000).Select(_5_i004));
        bool _13_v012;
        _13_v012 = !(_12_v011);
        long _14_v013 = Candidate.I64.Witness;
        if (_13_v012) {
          long _15_v014;
          _15_v014 = 1L;
          long _16_v015;
          _16_v015 = (_7_v006) + (_15_v014);
          _14_v013 = _16_v015;
        } else {
          _14_v013 = _7_v006;
        }
        Candidate._IR000 _17_v016;
        _17_v016 = Candidate.R000.create(_9_v008, _14_v013, _10_v009);
        _4_v004 = _17_v016;
        _5_i004 = (_5_i004) + (BigInteger.One);
      }
      result = _4_v004;
      return result;
    }
  ...
  public partial class I64 {
    ...
    public static readonly long Witness = (long)(BigInteger.Zero);
    private static readonly Dafny.TypeDescriptor<long> _TYPE = new Dafny.TypeDescriptor<long>(Candidate.I64.Witness);
  ...
  public partial class S000 {
    private static readonly Dafny.ISequence<long> Witness = Dafny.Sequence<long>.FromElements();
    public static Dafny.ISequence<long> Default() {
      return Witness;
    }
    private static readonly Dafny.TypeDescriptor<Dafny.ISequence<long>> _TYPE = new Dafny.TypeDescriptor<Dafny.ISequence<long>>(Candidate.S000.Default());
    public static Dafny.TypeDescriptor<Dafny.ISequence<long>> _TypeDescriptor() {
      return _TYPE;
    }
    public static bool _Is(Dafny.ISequence<long> __source) {
      Dafny.ISequence<long> _18_s = __source;
      return (new BigInteger((_18_s).Count)) <= (BigInteger.One);
    }
  }

  public partial class S001 {
    private static readonly Dafny.ISequence<long> Witness = Dafny.Sequence<long>.FromElements();
    public static Dafny.ISequence<long> Default() {
      return Witness;
    }
    private static readonly Dafny.TypeDescriptor<Dafny.ISequence<long>> _TYPE = new Dafny.TypeDescriptor<Dafny.ISequence<long>>(Candidate.S001.Default());
    public static Dafny.TypeDescriptor<Dafny.ISequence<long>> _TypeDescriptor() {
      return _TYPE;
    }
    public static bool _Is(Dafny.ISequence<long> __source) {
      Dafny.ISequence<long> _19_s = __source;
      return (new BigInteger((_19_s).Count)) <= (new BigInteger(8));
    }
  }

  public interface _IR000 {
    bool is_C000 { get; }
    Dafny.ISequence<long> dtor_R000F000 { get; }
    long dtor_R000F001 { get; }
    long dtor_R000F002 { get; }
    _IR000 DowncastClone();
  }
  public class R000 : _IR000 {
    public readonly Dafny.ISequence<long> _R000F000;
    public readonly long _R000F001;
    public readonly long _R000F002;
    public R000(Dafny.ISequence<long> R000F000, long R000F001, long R000F002) {
      this._R000F000 = R000F000;
      this._R000F001 = R000F001;
      this._R000F002 = R000F002;
    }
    public _IR000 DowncastClone() {
      if (this is _IR000 dt) { return dt; }
      return new R000(_R000F000, _R000F001, _R000F002);
    }
    public override bool Equals(object other) {
      var oth = other as Candidate.R000;
      return oth != null && object.Equals(this._R000F000, oth._R000F000) && this._R000F001 == oth._R000F001 && this._R000F002 == oth._R000F002;
    }
    public override int GetHashCode() {
      ulong hash = 5381;
      hash = ((hash << 5) + hash) + 0;
      hash = ((hash << 5) + hash) + ((ulong)Dafny.Helpers.GetHashCode(this._R000F000));
      hash = ((hash << 5) + hash) + ((ulong)Dafny.Helpers.GetHashCode(this._R000F001));
      hash = ((hash << 5) + hash) + ((ulong)Dafny.Helpers.GetHashCode(this._R000F002));
      return (int) hash;
    }
    public override string ToString() {
      string s = "Candidate.R000.C000";
      s += "(";
      s += Dafny.Helpers.ToString(this._R000F000);
      s += ", ";
      s += Dafny.Helpers.ToString(this._R000F001);
      s += ", ";
      s += Dafny.Helpers.ToString(this._R000F002);
      s += ")";
      return s;
    }
    private static readonly Candidate._IR000 theDefault = create(Candidate.S001.Default(), Candidate.I64.Witness, Candidate.I64.Witness);
    public static Candidate._IR000 Default() {
      return theDefault;
    }
    private static readonly Dafny.TypeDescriptor<Candidate._IR000> _TYPE = new Dafny.TypeDescriptor<Candidate._IR000>(Candidate.R000.Default());
    public static Dafny.TypeDescriptor<Candidate._IR000> _TypeDescriptor() {
      return _TYPE;
    }
    public static _IR000 create(Dafny.ISequence<long> R000F000, long R000F001, long R000F002) {
      return new R000(R000F000, R000F001, R000F002);
    }
    public static _IR000 create_C000(Dafny.ISequence<long> R000F000, long R000F001, long R000F002) {
      return create(R000F000, R000F001, R000F002);
    }
    public bool is_C000 { get { return true; } }
    public Dafny.ISequence<long> dtor_R000F000 {
      get {
        return this._R000F000;
      }
    }
    public long dtor_R000F001 {
      get {
        return this._R000F001;
      }
    }
    public long dtor_R000F002 {
      get {
        return this._R000F002;
      }
    }
  }
} // end of namespace Candidate
namespace PortableWrapper {

  public partial class __default {
    public static bool IsI64(PortableWrapper._IWireValue @value) {
      return ((@value).is_WI64) && (((new BigInteger(-9223372036854775808L)) <= ((@value).dtor_i64Value)) && (((@value).dtor_i64Value) <= (new BigInteger(9223372036854775807L))));
    }
    public static long ToI64(PortableWrapper._IWireValue @value) {
      return (long)((@value).dtor_i64Value);
    }
    public static bool IsI64Sequence(PortableWrapper._IWireValue @value, BigInteger capacity)
    {
      return (((@value).is_WSeq) && ((new BigInteger(((@value).dtor_sequenceItems).Count)) <= (capacity))) && (Dafny.Helpers.Id<Func<PortableWrapper._IWireValue, bool>>((_0_value) => Dafny.Helpers.Quantifier<BigInteger>(Dafny.Helpers.IntegerRange(BigInteger.Zero, new BigInteger(((_0_value).dtor_sequenceItems).Count)), true, (((_forall_var_0) => {
        BigInteger _1_index = (BigInteger)_forall_var_0;
        return !(((_1_index).Sign != -1) && ((_1_index) < (new BigInteger(((_0_value).dtor_sequenceItems).Count)))) || (PortableWrapper.__default.IsI64(((_0_value).dtor_sequenceItems).Select(_1_index)));
      }))))(@value));
    }
    public static Dafny.ISequence<long> ToI64Sequence(Dafny.ISequence<PortableWrapper._IWireValue> items) {
      Dafny.ISequence<long> _0___accumulator = Dafny.Sequence<long>.FromElements();
    TAIL_CALL_START: ;
      if ((new BigInteger((items).Count)).Sign == 0) {
        return Dafny.Sequence<long>.Concat(_0___accumulator, Dafny.Sequence<long>.FromElements());
      } else {
        _0___accumulator = Dafny.Sequence<long>.Concat(_0___accumulator, Dafny.Sequence<long>.FromElements(PortableWrapper.__default.ToI64((items).Select(BigInteger.Zero))));
        Dafny.ISequence<PortableWrapper._IWireValue> _in0 = (items).Drop(BigInteger.One);
        items = _in0;
        goto TAIL_CALL_START;
      }
    }
    public static PortableWrapper._IWireValue FromI64Sequence(Dafny.ISequence<long> items) {
      return PortableWrapper.WireValue.create_WSeq(((System.Func<Dafny.ISequence<PortableWrapper._IWireValue>>) (() => {
  BigInteger dim0 = new BigInteger((items).Count);
  var arr0 = new PortableWrapper._IWireValue[Dafny.Helpers.ToIntChecked(dim0, "array size exceeds memory limit")];
  for (int i0 = 0; i0 < dim0; i0++) {
    var _0_index = (BigInteger) i0;
    arr0[(int)(_0_index)] = PortableWrapper.WireValue.create_WI64(new BigInteger((items).Select(_0_index)));
  }
  return Dafny.Sequence<PortableWrapper._IWireValue>.FromArray(arr0);
}))());
    }
    public static Dafny.ISequence<Dafny.Rune> SequenceMismatchLocus(PortableWrapper._IWireValue @value, BigInteger capacity, Dafny.ISequence<Dafny.Rune> locus)
    {
      if ((!((@value).is_WSeq)) || ((new BigInteger(((@value).dtor_sequenceItems).Count)) > (capacity))) {
        return locus;
      } else if (((new BigInteger(((@value).dtor_sequenceItems).Count)).Sign == 1) && (!(PortableWrapper.__default.IsI64(((@value).dtor_sequenceItems).Select(BigInteger.Zero))))) {
        return Dafny.Sequence<Dafny.Rune>.Concat(locus, Dafny.Sequence<Dafny.Rune>.UnicodeFromString("/items/0"));
      } else if (((new BigInteger(((@value).dtor_sequenceItems).Count)) > (BigInteger.One)) && (!(PortableWrapper.__default.IsI64(((@value).dtor_sequenceItems).Select(BigInteger.One))))) {
        return Dafny.Sequence<Dafny.Rune>.Concat(locus, Dafny.Sequence<Dafny.Rune>.UnicodeFromString("/items/1"));
      } else if (((new BigInteger(((@value).dtor_sequenceItems).Count)) > (new BigInteger(2))) && (!(PortableWrapper.__default.IsI64(((@value).dtor_sequenceItems).Select(new BigInteger(2)))))) {
        return Dafny.Sequence<Dafny.Rune>.Concat(locus, Dafny.Sequence<Dafny.Rune>.UnicodeFromString("/items/2"));
      } else if (((new BigInteger(((@value).dtor_sequenceItems).Count)) > (new BigInteger(3))) && (!(PortableWrapper.__default.IsI64(((@value).dtor_sequenceItems).Select(new BigInteger(3)))))) {
        return Dafny.Sequence<Dafny.Rune>.Concat(locus, Dafny.Sequence<Dafny.Rune>.UnicodeFromString("/items/3"));
      } else if (((new BigInteger(((@value).dtor_sequenceItems).Count)) > (new BigInteger(4))) && (!(PortableWrapper.__default.IsI64(((@value).dtor_sequenceItems).Select(new BigInteger(4)))))) {
        return Dafny.Sequence<Dafny.Rune>.Concat(locus, Dafny.Sequence<Dafny.Rune>.UnicodeFromString("/items/4"));
      } else if (((new BigInteger(((@value).dtor_sequenceItems).Count)) > (new BigInteger(5))) && (!(PortableWrapper.__default.IsI64(((@value).dtor_sequenceItems).Select(new BigInteger(5)))))) {
        return Dafny.Sequence<Dafny.Rune>.Concat(locus, Dafny.Sequence<Dafny.Rune>.UnicodeFromString("/items/5"));
      } else if (((new BigInteger(((@value).dtor_sequenceItems).Count)) > (new BigInteger(6))) && (!(PortableWrapper.__default.IsI64(((@value).dtor_sequenceItems).Select(new BigInteger(6)))))) {
        return Dafny.Sequence<Dafny.Rune>.Concat(locus, Dafny.Sequence<Dafny.Rune>.UnicodeFromString("/items/6"));
      } else if (((new BigInteger(((@value).dtor_sequenceItems).Count)) > (new BigInteger(7))) && (!(PortableWrapper.__default.IsI64(((@value).dtor_sequenceItems).Select(new BigInteger(7)))))) {
        return Dafny.Sequence<Dafny.Rune>.Concat(locus, Dafny.Sequence<Dafny.Rune>.UnicodeFromString("/items/7"));
      } else {
        return locus;
      }
    }
    public static bool IsSummary(PortableWrapper._IWireValue @value) {
      return (((((((((@value).is_WRecord) && (((@value).dtor_recordTypeId).Equals(Dafny.Sequence<Dafny.Rune>.UnicodeFromString("Summary")))) && ((new BigInteger(((@value).dtor_recordFields).Count)) == (new BigInteger(3)))) && (((((@value).dtor_recordFields).Select(BigInteger.Zero)).dtor_fieldId).Equals(Dafny.Sequence<Dafny.Rune>.UnicodeFromString("echo")))) && (PortableWrapper.__default.IsI64Sequence((((@value).dtor_recordFields).Select(BigInteger.Zero)).dtor_fieldValue, new BigInteger(8)))) && (((((@value).dtor_recordFields).Select(BigInteger.One)).dtor_fieldId).Equals(Dafny.Sequence<Dafny.Rune>.UnicodeFromString("negativeCount")))) && (PortableWrapper.__default.IsI64((((@value).dtor_recordFields).Select(BigInteger.One)).dtor_fieldValue))) && (((((@value).dtor_recordFields).Select(new BigInteger(2))).dtor_fieldId).Equals(Dafny.Sequence<Dafny.Rune>.UnicodeFromString("sum")))) && (PortableWrapper.__default.IsI64((((@value).dtor_recordFields).Select(new BigInteger(2))).dtor_fieldValue));
    }
    public static Dafny.ISequence<Dafny.Rune> SummaryMismatchLocus(PortableWrapper._IWireValue @value, Dafny.ISequence<Dafny.Rune> locus)
    {
      if (((!((@value).is_WRecord)) || (!((@value).dtor_recordTypeId).Equals(Dafny.Sequence<Dafny.Rune>.UnicodeFromString("Summary")))) || ((new BigInteger(((@value).dtor_recordFields).Count)) != (new BigInteger(3)))) {
        return locus;
      } else if (!((((@value).dtor_recordFields).Select(BigInteger.Zero)).dtor_fieldId).Equals(Dafny.Sequence<Dafny.Rune>.UnicodeFromString("echo"))) {
        return locus;
      } else if (!(PortableWrapper.__default.IsI64Sequence((((@value).dtor_recordFields).Select(BigInteger.Zero)).dtor_fieldValue, new BigInteger(8)))) {
        return PortableWrapper.__default.SequenceMismatchLocus((((@value).dtor_recordFields).Select(BigInteger.Zero)).dtor_fieldValue, new BigInteger(8), Dafny.Sequence<Dafny.Rune>.Concat(locus, Dafny.Sequence<Dafny.Rune>.UnicodeFromString("/fields/0/value")));
      } else if (!((((@value).dtor_recordFields).Select(BigInteger.One)).dtor_fieldId).Equals(Dafny.Sequence<Dafny.Rune>.UnicodeFromString("negativeCount"))) {
        return locus;
      } else if (!(PortableWrapper.__default.IsI64((((@value).dtor_recordFields).Select(BigInteger.One)).dtor_fieldValue))) {
        return Dafny.Sequence<Dafny.Rune>.Concat(locus, Dafny.Sequence<Dafny.Rune>.UnicodeFromString("/fields/1/value"));
      } else if (!((((@value).dtor_recordFields).Select(new BigInteger(2))).dtor_fieldId).Equals(Dafny.Sequence<Dafny.Rune>.UnicodeFromString("sum"))) {
        return locus;
      } else if (!(PortableWrapper.__default.IsI64((((@value).dtor_recordFields).Select(new BigInteger(2))).dtor_fieldValue))) {
        return Dafny.Sequence<Dafny.Rune>.Concat(locus, Dafny.Sequence<Dafny.Rune>.UnicodeFromString("/fields/2/value"));
      } else {
        return locus;
      }
    }
    public static Candidate._IR000 ToSummary(PortableWrapper._IWireValue @value) {
      return Candidate.R000.create(PortableWrapper.__default.ToI64Sequence(((((@value).dtor_recordFields).Select(BigInteger.Zero)).dtor_fieldValue).dtor_sequenceItems), PortableWrapper.__default.ToI64((((@value).dtor_recordFields).Select(BigInteger.One)).dtor_fieldValue), PortableWrapper.__default.ToI64((((@value).dtor_recordFields).Select(new BigInteger(2))).dtor_fieldValue));
    }
    public static PortableWrapper._IWireValue FromSummary(Candidate._IR000 @value) {
      return PortableWrapper.WireValue.create_WRecord(Dafny.Sequence<Dafny.Rune>.UnicodeFromString("Summary"), Dafny.Sequence<PortableWrapper._IWireField>.FromElements(PortableWrapper.WireField.create(Dafny.Sequence<Dafny.Rune>.UnicodeFromString("echo"), PortableWrapper.__default.FromI64Sequence((@value).dtor_R000F000)), PortableWrapper.WireField.create(Dafny.Sequence<Dafny.Rune>.UnicodeFromString("negativeCount"), PortableWrapper.WireValue.create_WI64(new BigInteger((@value).dtor_R000F001))), PortableWrapper.WireField.create(Dafny.Sequence<Dafny.Rune>.UnicodeFromString("sum"), PortableWrapper.WireValue.create_WI64(new BigInteger((@value).dtor_R000F002)))));
    }
    public static PortableWrapper._IWireOutcome ArityRefusal(BigInteger expected, BigInteger actual)
    {
      return PortableWrapper.WireOutcome.create_Refusal(Dafny.Sequence<Dafny.Rune>.UnicodeFromString("ArityMismatch"), Dafny.Sequence<Dafny.Rune>.UnicodeFromString("$/arguments"), Dafny.Sequence<PortableWrapper._IWireDetail>.FromElements(PortableWrapper.WireDetail.create(Dafny.Sequence<Dafny.Rune>.UnicodeFromString("expected"), PortableWrapper.WireDetailValue.create_DNat(expected)), PortableWrapper.WireDetail.create(Dafny.Sequence<Dafny.Rune>.UnicodeFromString("actual"), PortableWrapper.WireDetailValue.create_DNat(actual))));
    }
    public static PortableWrapper._IWireOutcome TypeRefusal(Dafny.ISequence<Dafny.Rune> locus) {
      return PortableWrapper.WireOutcome.create_Refusal(Dafny.Sequence<Dafny.Rune>.UnicodeFromString("RuntimeTypeMismatch"), locus, Dafny.Sequence<PortableWrapper._IWireDetail>.FromElements());
    }
    public static PortableWrapper._IWireOutcome Invoke(Dafny.ISequence<Dafny.Rune> functionId, Dafny.ISequence<PortableWrapper._IWireValue> arguments)
    {
      PortableWrapper._IWireOutcome outcome = PortableWrapper.WireOutcome.Default();
      if (((((!(functionId).Equals(Dafny.Sequence<Dafny.Rune>.UnicodeFromString("adjust"))) && (!(functionId).Equals(Dafny.Sequence<Dafny.Rune>.UnicodeFromString("echoSummary")))) && (!(functionId).Equals(Dafny.Sequence<Dafny.Rune>.UnicodeFromString("headOrZero")))) && (!(functionId).Equals(Dafny.Sequence<Dafny.Rune>.UnicodeFromString("increment")))) && (!(functionId).Equals(Dafny.Sequence<Dafny.Rune>.UnicodeFromString("summarize")))) {
        outcome = PortableWrapper.WireOutcome.create_Refusal(Dafny.Sequence<Dafny.Rune>.UnicodeFromString("UnknownFunction"), Dafny.Sequence<Dafny.Rune>.UnicodeFromString("$/functionId"), Dafny.Sequence<PortableWrapper._IWireDetail>.FromElements(PortableWrapper.WireDetail.create(Dafny.Sequence<Dafny.Rune>.UnicodeFromString("functionId"), PortableWrapper.WireDetailValue.create_DText(functionId))));
      } else if ((functionId).Equals(Dafny.Sequence<Dafny.Rune>.UnicodeFromString("adjust"))) {
        if ((new BigInteger((arguments).Count)) != (new BigInteger(2))) {
          outcome = PortableWrapper.__default.ArityRefusal(new BigInteger(2), new BigInteger((arguments).Count));
        } else if (!(((arguments).Select(BigInteger.Zero)).is_WBool)) {
          outcome = PortableWrapper.__default.TypeRefusal(Dafny.Sequence<Dafny.Rune>.UnicodeFromString("$/arguments/0"));
        } else if (!(PortableWrapper.__default.IsI64((arguments).Select(BigInteger.One)))) {
          outcome = PortableWrapper.__default.TypeRefusal(Dafny.Sequence<Dafny.Rune>.UnicodeFromString("$/arguments/1"));
        } else {
          bool _0_increase;
          _0_increase = ((arguments).Select(BigInteger.Zero)).dtor_boolValue;
          long _1_x;
          _1_x = PortableWrapper.__default.ToI64((arguments).Select(BigInteger.One));
          if (!(Candidate.__default.Q000(_0_increase, _1_x))) {
            outcome = PortableWrapper.WireOutcome.create_Refusal(Dafny.Sequence<Dafny.Rune>.UnicodeFromString("OwnerPreconditionFailed"), Dafny.Sequence<Dafny.Rune>.UnicodeFromString("function/adjust/requires"), Dafny.Sequence<PortableWrapper._IWireDetail>.FromElements());
          } else {
            long _2_result;
            long _out0;
            _out0 = Candidate.__default.F000(_0_increase, _1_x);
            _2_result = _out0;
            outcome = PortableWrapper.WireOutcome.create_Success(PortableWrapper.WireValue.create_WI64(new BigInteger(_2_result)));
          }
        }
      } else if ((functionId).Equals(Dafny.Sequence<Dafny.Rune>.UnicodeFromString("echoSummary"))) {
        if ((new BigInteger((arguments).Count)) != (BigInteger.One)) {
          outcome = PortableWrapper.__default.ArityRefusal(BigInteger.One, new BigInteger((arguments).Count));
        } else if (!(PortableWrapper.__default.IsSummary((arguments).Select(BigInteger.Zero)))) {
          outcome = PortableWrapper.__default.TypeRefusal(PortableWrapper.__default.SummaryMismatchLocus((arguments).Select(BigInteger.Zero), Dafny.Sequence<Dafny.Rune>.UnicodeFromString("$/arguments/0")));
        } else {
          Candidate._IR000 _3_summary;
          _3_summary = PortableWrapper.__default.ToSummary((arguments).Select(BigInteger.Zero));
          Candidate._IR000 _4_result;
          Candidate._IR000 _out1;
          _out1 = Candidate.__default.F001(_3_summary);
          _4_result = _out1;
          outcome = PortableWrapper.WireOutcome.create_Success(PortableWrapper.__default.FromSummary(_4_result));
        }
      } else if ((functionId).Equals(Dafny.Sequence<Dafny.Rune>.UnicodeFromString("headOrZero"))) {
        if ((new BigInteger((arguments).Count)) != (BigInteger.One)) {
          outcome = PortableWrapper.__default.ArityRefusal(BigInteger.One, new BigInteger((arguments).Count));
        } else if (!(PortableWrapper.__default.IsI64Sequence((arguments).Select(BigInteger.Zero), BigInteger.One))) {
          outcome = PortableWrapper.__default.TypeRefusal(PortableWrapper.__default.SequenceMismatchLocus((arguments).Select(BigInteger.Zero), BigInteger.One, Dafny.Sequence<Dafny.Rune>.UnicodeFromString("$/arguments/0")));
        } else {
          Dafny.ISequence<long> _5_items;
          _5_items = PortableWrapper.__default.ToI64Sequence(((arguments).Select(BigInteger.Zero)).dtor_sequenceItems);
          long _6_result;
          long _out2;
          _out2 = Candidate.__default.F002(_5_items);
          _6_result = _out2;
          outcome = PortableWrapper.WireOutcome.create_Success(PortableWrapper.WireValue.create_WI64(new BigInteger(_6_result)));
        }
      } else if ((functionId).Equals(Dafny.Sequence<Dafny.Rune>.UnicodeFromString("increment"))) {
        if ((new BigInteger((arguments).Count)) != (BigInteger.One)) {
          outcome = PortableWrapper.__default.ArityRefusal(BigInteger.One, new BigInteger((arguments).Count));
        } else if (!(PortableWrapper.__default.IsI64((arguments).Select(BigInteger.Zero)))) {
          outcome = PortableWrapper.__default.TypeRefusal(Dafny.Sequence<Dafny.Rune>.UnicodeFromString("$/arguments/0"));
        } else {
          long _7_x;
          _7_x = PortableWrapper.__default.ToI64((arguments).Select(BigInteger.Zero));
          if (!(Candidate.__default.Q003(_7_x))) {
            outcome = PortableWrapper.WireOutcome.create_Refusal(Dafny.Sequence<Dafny.Rune>.UnicodeFromString("OwnerPreconditionFailed"), Dafny.Sequence<Dafny.Rune>.UnicodeFromString("function/increment/requires"), Dafny.Sequence<PortableWrapper._IWireDetail>.FromElements());
          } else {
            long _8_result;
            long _out3;
            _out3 = Candidate.__default.F003(_7_x);
            _8_result = _out3;
            outcome = PortableWrapper.WireOutcome.create_Success(PortableWrapper.WireValue.create_WI64(new BigInteger(_8_result)));
          }
        }
      } else {
        if ((new BigInteger((arguments).Count)) != (BigInteger.One)) {
          outcome = PortableWrapper.__default.ArityRefusal(BigInteger.One, new BigInteger((arguments).Count));
        } else if (!(PortableWrapper.__default.IsI64Sequence((arguments).Select(BigInteger.Zero), new BigInteger(8)))) {
          outcome = PortableWrapper.__default.TypeRefusal(PortableWrapper.__default.SequenceMismatchLocus((arguments).Select(BigInteger.Zero), new BigInteger(8), Dafny.Sequence<Dafny.Rune>.UnicodeFromString("$/arguments/0")));
        } else {
          Dafny.ISequence<long> _9_items;
          _9_items = PortableWrapper.__default.ToI64Sequence(((arguments).Select(BigInteger.Zero)).dtor_sequenceItems);
          if (!(Candidate.__default.Q004(_9_items))) {
            outcome = PortableWrapper.WireOutcome.create_Refusal(Dafny.Sequence<Dafny.Rune>.UnicodeFromString("OwnerPreconditionFailed"), Dafny.Sequence<Dafny.Rune>.UnicodeFromString("function/summarize/requires"), Dafny.Sequence<PortableWrapper._IWireDetail>.FromElements());
          } else {
            Candidate._IR000 _10_result;
            Candidate._IR000 _out4;
            _out4 = Candidate.__default.F004(_9_items);
            _10_result = _out4;
            outcome = PortableWrapper.WireOutcome.create_Success(PortableWrapper.__default.FromSummary(_10_result));
          }
        }
      }
      return outcome;
  ...
  public interface _IWireValue {
    bool is_WI64 { get; }
    bool is_WBool { get; }
    bool is_WRecord { get; }
    bool is_WSeq { get; }
    BigInteger dtor_i64Value { get; }
    bool dtor_boolValue { get; }
    Dafny.ISequence<Dafny.Rune> dtor_recordTypeId { get; }
    Dafny.ISequence<PortableWrapper._IWireField> dtor_recordFields { get; }
    Dafny.ISequence<PortableWrapper._IWireValue> dtor_sequenceItems { get; }
    _IWireValue DowncastClone();
  }
  public abstract class WireValue : _IWireValue {
    public WireValue() {
    }
    private static readonly PortableWrapper._IWireValue theDefault = create_WI64(BigInteger.Zero);
    public static PortableWrapper._IWireValue Default() {
      return theDefault;
    }
    private static readonly Dafny.TypeDescriptor<PortableWrapper._IWireValue> _TYPE = new Dafny.TypeDescriptor<PortableWrapper._IWireValue>(PortableWrapper.WireValue.Default());
    public static Dafny.TypeDescriptor<PortableWrapper._IWireValue> _TypeDescriptor() {
      return _TYPE;
    }
    public static _IWireValue create_WI64(BigInteger i64Value) {
      return new WireValue_WI64(i64Value);
    }
    public static _IWireValue create_WBool(bool boolValue) {
      return new WireValue_WBool(boolValue);
    }
    public static _IWireValue create_WRecord(Dafny.ISequence<Dafny.Rune> recordTypeId, Dafny.ISequence<PortableWrapper._IWireField> recordFields) {
      return new WireValue_WRecord(recordTypeId, recordFields);
    }
    public static _IWireValue create_WSeq(Dafny.ISequence<PortableWrapper._IWireValue> sequenceItems) {
      return new WireValue_WSeq(sequenceItems);
    }
    public bool is_WI64 { get { return this is WireValue_WI64; } }
    public bool is_WBool { get { return this is WireValue_WBool; } }
    public bool is_WRecord { get { return this is WireValue_WRecord; } }
    public bool is_WSeq { get { return this is WireValue_WSeq; } }
    public BigInteger dtor_i64Value {
      get {
        var d = this;
        return ((WireValue_WI64)d)._i64Value;
      }
    }
    public bool dtor_boolValue {
      get {
        var d = this;
        return ((WireValue_WBool)d)._boolValue;
      }
    }
    public Dafny.ISequence<Dafny.Rune> dtor_recordTypeId {
      get {
        var d = this;
        return ((WireValue_WRecord)d)._recordTypeId;
      }
    }
    public Dafny.ISequence<PortableWrapper._IWireField> dtor_recordFields {
      get {
        var d = this;
        return ((WireValue_WRecord)d)._recordFields;
      }
    }
    public Dafny.ISequence<PortableWrapper._IWireValue> dtor_sequenceItems {
      get {
        var d = this;
        return ((WireValue_WSeq)d)._sequenceItems;
      }
    }
    public abstract _IWireValue DowncastClone();
  }
  public class WireValue_WI64 : WireValue {
    public readonly BigInteger _i64Value;
    public WireValue_WI64(BigInteger i64Value) : base() {
      this._i64Value = i64Value;
    }
    public override _IWireValue DowncastClone() {
      if (this is _IWireValue dt) { return dt; }
      return new WireValue_WI64(_i64Value);
    }
    public override bool Equals(object other) {
      var oth = other as PortableWrapper.WireValue_WI64;
      return oth != null && this._i64Value == oth._i64Value;
    }
    public override int GetHashCode() {
      ulong hash = 5381;
      hash = ((hash << 5) + hash) + 0;
      hash = ((hash << 5) + hash) + ((ulong)Dafny.Helpers.GetHashCode(this._i64Value));
      return (int) hash;
    }
    public override string ToString() {
      string s = "PortableWrapper.WireValue.WI64";
      s += "(";
      s += Dafny.Helpers.ToString(this._i64Value);
      s += ")";
      return s;
    }
  }
  public class WireValue_WBool : WireValue {
    public readonly bool _boolValue;
    public WireValue_WBool(bool boolValue) : base() {
      this._boolValue = boolValue;
    }
    public override _IWireValue DowncastClone() {
      if (this is _IWireValue dt) { return dt; }
      return new WireValue_WBool(_boolValue);
    }
    public override bool Equals(object other) {
      var oth = other as PortableWrapper.WireValue_WBool;
    ...
    public override string ToString() {
      string s = "PortableWrapper.WireValue.WBool";
      s += "(";
  ...
  public class WireValue_WRecord : WireValue {
    public readonly Dafny.ISequence<Dafny.Rune> _recordTypeId;
    public readonly Dafny.ISequence<PortableWrapper._IWireField> _recordFields;
    public WireValue_WRecord(Dafny.ISequence<Dafny.Rune> recordTypeId, Dafny.ISequence<PortableWrapper._IWireField> recordFields) : base() {
      this._recordTypeId = recordTypeId;
      this._recordFields = recordFields;
    }
    public override _IWireValue DowncastClone() {
      if (this is _IWireValue dt) { return dt; }
      return new WireValue_WRecord(_recordTypeId, _recordFields);
    }
    public override bool Equals(object other) {
      var oth = other as PortableWrapper.WireValue_WRecord;
      return oth != null && object.Equals(this._recordTypeId, oth._recordTypeId) && object.Equals(this._recordFields, oth._recordFields);
    }
    public override int GetHashCode() {
      ulong hash = 5381;
      hash = ((hash << 5) + hash) + 2;
      hash = ((hash << 5) + hash) + ((ulong)Dafny.Helpers.GetHashCode(this._recordTypeId));
      hash = ((hash << 5) + hash) + ((ulong)Dafny.Helpers.GetHashCode(this._recordFields));
      return (int) hash;
    }
    public override string ToString() {
      string s = "PortableWrapper.WireValue.WRecord";
      s += "(";
      s += this._recordTypeId.ToVerbatimString(true);
      s += ", ";
      s += Dafny.Helpers.ToString(this._recordFields);
      s += ")";
      return s;
    }
  }
  public class WireValue_WSeq : WireValue {
    public readonly Dafny.ISequence<PortableWrapper._IWireValue> _sequenceItems;
    public WireValue_WSeq(Dafny.ISequence<PortableWrapper._IWireValue> sequenceItems) : base() {
      this._sequenceItems = sequenceItems;
    }
    public override _IWireValue DowncastClone() {
      if (this is _IWireValue dt) { return dt; }
      return new WireValue_WSeq(_sequenceItems);
    }
    public override bool Equals(object other) {
      var oth = other as PortableWrapper.WireValue_WSeq;
      return oth != null && object.Equals(this._sequenceItems, oth._sequenceItems);
    }
    public override int GetHashCode() {
      ulong hash = 5381;
      hash = ((hash << 5) + hash) + 3;
      hash = ((hash << 5) + hash) + ((ulong)Dafny.Helpers.GetHashCode(this._sequenceItems));
      return (int) hash;
    }
    public override string ToString() {
      string s = "PortableWrapper.WireValue.WSeq";
      s += "(";
      s += Dafny.Helpers.ToString(this._sequenceItems);
      s += ")";
      return s;
    }
  }

  public interface _IWireField {
    bool is_WireField { get; }
    Dafny.ISequence<Dafny.Rune> dtor_fieldId { get; }
    PortableWrapper._IWireValue dtor_fieldValue { get; }
    _IWireField DowncastClone();
  }
  public class WireField : _IWireField {
    public readonly Dafny.ISequence<Dafny.Rune> _fieldId;
    public readonly PortableWrapper._IWireValue _fieldValue;
    public WireField(Dafny.ISequence<Dafny.Rune> fieldId, PortableWrapper._IWireValue fieldValue) {
      this._fieldId = fieldId;
      this._fieldValue = fieldValue;
    }
    public _IWireField DowncastClone() {
      if (this is _IWireField dt) { return dt; }
      return new WireField(_fieldId, _fieldValue);
    }
    public override bool Equals(object other) {
      var oth = other as PortableWrapper.WireField;
      return oth != null && object.Equals(this._fieldId, oth._fieldId) && object.Equals(this._fieldValue, oth._fieldValue);
    }
    public override int GetHashCode() {
      ulong hash = 5381;
      hash = ((hash << 5) + hash) + 0;
      hash = ((hash << 5) + hash) + ((ulong)Dafny.Helpers.GetHashCode(this._fieldId));
      hash = ((hash << 5) + hash) + ((ulong)Dafny.Helpers.GetHashCode(this._fieldValue));
      return (int) hash;
    }
    public override string ToString() {
      string s = "PortableWrapper.WireField.WireField";
      s += "(";
      s += this._fieldId.ToVerbatimString(true);
      s += ", ";
      s += Dafny.Helpers.ToString(this._fieldValue);
      s += ")";
      return s;
    }
    private static readonly PortableWrapper._IWireField theDefault = create(Dafny.Sequence<Dafny.Rune>.Empty, PortableWrapper.WireValue.Default());
    public static PortableWrapper._IWireField Default() {
      return theDefault;
    }
    private static readonly Dafny.TypeDescriptor<PortableWrapper._IWireField> _TYPE = new Dafny.TypeDescriptor<PortableWrapper._IWireField>(PortableWrapper.WireField.Default());
    public static Dafny.TypeDescriptor<PortableWrapper._IWireField> _TypeDescriptor() {
      return _TYPE;
    }
    public static _IWireField create(Dafny.ISequence<Dafny.Rune> fieldId, PortableWrapper._IWireValue fieldValue) {
      return new WireField(fieldId, fieldValue);
    }
    public static _IWireField create_WireField(Dafny.ISequence<Dafny.Rune> fieldId, PortableWrapper._IWireValue fieldValue) {
      return create(fieldId, fieldValue);
    }
    public bool is_WireField { get { return true; } }
    public Dafny.ISequence<Dafny.Rune> dtor_fieldId {
      get {
        return this._fieldId;
      }
    }
    public PortableWrapper._IWireValue dtor_fieldValue {
      get {
  ...
  public interface _IWireDetailValue {
    bool is_DText { get; }
    bool is_DNat { get; }
    Dafny.ISequence<Dafny.Rune> dtor_text { get; }
    BigInteger dtor_value { get; }
    _IWireDetailValue DowncastClone();
  }
  public abstract class WireDetailValue : _IWireDetailValue {
    public WireDetailValue() {
    }
    private static readonly PortableWrapper._IWireDetailValue theDefault = create_DText(Dafny.Sequence<Dafny.Rune>.Empty);
    public static PortableWrapper._IWireDetailValue Default() {
      return theDefault;
    }
    private static readonly Dafny.TypeDescriptor<PortableWrapper._IWireDetailValue> _TYPE = new Dafny.TypeDescriptor<PortableWrapper._IWireDetailValue>(PortableWrapper.WireDetailValue.Default());
    public static Dafny.TypeDescriptor<PortableWrapper._IWireDetailValue> _TypeDescriptor() {
      return _TYPE;
    }
    public static _IWireDetailValue create_DText(Dafny.ISequence<Dafny.Rune> text) {
      return new WireDetailValue_DText(text);
    }
    public static _IWireDetailValue create_DNat(BigInteger @value) {
      return new WireDetailValue_DNat(@value);
    }
    public bool is_DText { get { return this is WireDetailValue_DText; } }
    public bool is_DNat { get { return this is WireDetailValue_DNat; } }
    public Dafny.ISequence<Dafny.Rune> dtor_text {
      get {
        var d = this;
        return ((WireDetailValue_DText)d)._text;
      }
    }
    public BigInteger dtor_value {
      get {
        var d = this;
        return ((WireDetailValue_DNat)d)._value;
      }
    }
    public abstract _IWireDetailValue DowncastClone();
  }
  public class WireDetailValue_DText : WireDetailValue {
    public readonly Dafny.ISequence<Dafny.Rune> _text;
    public WireDetailValue_DText(Dafny.ISequence<Dafny.Rune> text) : base() {
      this._text = text;
    }
    public override _IWireDetailValue DowncastClone() {
      if (this is _IWireDetailValue dt) { return dt; }
      return new WireDetailValue_DText(_text);
    }
    public override bool Equals(object other) {
      var oth = other as PortableWrapper.WireDetailValue_DText;
      return oth != null && object.Equals(this._text, oth._text);
    }
    public override int GetHashCode() {
      ulong hash = 5381;
      hash = ((hash << 5) + hash) + 0;
      hash = ((hash << 5) + hash) + ((ulong)Dafny.Helpers.GetHashCode(this._text));
      return (int) hash;
    }
    public override string ToString() {
      string s = "PortableWrapper.WireDetailValue.DText";
      s += "(";
      s += this._text.ToVerbatimString(true);
      s += ")";
      return s;
    }
  }
  public class WireDetailValue_DNat : WireDetailValue {
    public readonly BigInteger _value;
    public WireDetailValue_DNat(BigInteger @value) : base() {
      this._value = @value;
    }
    public override _IWireDetailValue DowncastClone() {
      if (this is _IWireDetailValue dt) { return dt; }
      return new WireDetailValue_DNat(_value);
    }
    public override bool Equals(object other) {
      var oth = other as PortableWrapper.WireDetailValue_DNat;
    ...
    public override string ToString() {
      string s = "PortableWrapper.WireDetailValue.DNat";
      s += "(";
  ...
  public interface _IWireDetail {
    bool is_WireDetail { get; }
    Dafny.ISequence<Dafny.Rune> dtor_key { get; }
    PortableWrapper._IWireDetailValue dtor_detailValue { get; }
    _IWireDetail DowncastClone();
  }
  public class WireDetail : _IWireDetail {
    public readonly Dafny.ISequence<Dafny.Rune> _key;
    public readonly PortableWrapper._IWireDetailValue _detailValue;
    public WireDetail(Dafny.ISequence<Dafny.Rune> key, PortableWrapper._IWireDetailValue detailValue) {
      this._key = key;
      this._detailValue = detailValue;
    }
    public _IWireDetail DowncastClone() {
      if (this is _IWireDetail dt) { return dt; }
      return new WireDetail(_key, _detailValue);
    }
    public override bool Equals(object other) {
      var oth = other as PortableWrapper.WireDetail;
      return oth != null && object.Equals(this._key, oth._key) && object.Equals(this._detailValue, oth._detailValue);
    }
    public override int GetHashCode() {
      ulong hash = 5381;
      hash = ((hash << 5) + hash) + 0;
      hash = ((hash << 5) + hash) + ((ulong)Dafny.Helpers.GetHashCode(this._key));
      hash = ((hash << 5) + hash) + ((ulong)Dafny.Helpers.GetHashCode(this._detailValue));
      return (int) hash;
    }
    public override string ToString() {
      string s = "PortableWrapper.WireDetail.WireDetail";
      s += "(";
      s += this._key.ToVerbatimString(true);
      s += ", ";
      s += Dafny.Helpers.ToString(this._detailValue);
      s += ")";
      return s;
    }
    private static readonly PortableWrapper._IWireDetail theDefault = create(Dafny.Sequence<Dafny.Rune>.Empty, PortableWrapper.WireDetailValue.Default());
    public static PortableWrapper._IWireDetail Default() {
      return theDefault;
    }
    private static readonly Dafny.TypeDescriptor<PortableWrapper._IWireDetail> _TYPE = new Dafny.TypeDescriptor<PortableWrapper._IWireDetail>(PortableWrapper.WireDetail.Default());
    public static Dafny.TypeDescriptor<PortableWrapper._IWireDetail> _TypeDescriptor() {
      return _TYPE;
    }
    public static _IWireDetail create(Dafny.ISequence<Dafny.Rune> key, PortableWrapper._IWireDetailValue detailValue) {
      return new WireDetail(key, detailValue);
    }
    public static _IWireDetail create_WireDetail(Dafny.ISequence<Dafny.Rune> key, PortableWrapper._IWireDetailValue detailValue) {
      return create(key, detailValue);
    }
    public bool is_WireDetail { get { return true; } }
    public Dafny.ISequence<Dafny.Rune> dtor_key {
      get {
        return this._key;
      }
    }
    public PortableWrapper._IWireDetailValue dtor_detailValue {
      get {
  ...
  public interface _IWireOutcome {
    bool is_Success { get; }
    bool is_Refusal { get; }
    PortableWrapper._IWireValue dtor_value { get; }
    Dafny.ISequence<Dafny.Rune> dtor_code { get; }
    Dafny.ISequence<Dafny.Rune> dtor_locus { get; }
    Dafny.ISequence<PortableWrapper._IWireDetail> dtor_details { get; }
    _IWireOutcome DowncastClone();
  }
  public abstract class WireOutcome : _IWireOutcome {
    public WireOutcome() {
    }
    private static readonly PortableWrapper._IWireOutcome theDefault = create_Success(PortableWrapper.WireValue.Default());
    public static PortableWrapper._IWireOutcome Default() {
      return theDefault;
    }
    private static readonly Dafny.TypeDescriptor<PortableWrapper._IWireOutcome> _TYPE = new Dafny.TypeDescriptor<PortableWrapper._IWireOutcome>(PortableWrapper.WireOutcome.Default());
    public static Dafny.TypeDescriptor<PortableWrapper._IWireOutcome> _TypeDescriptor() {
      return _TYPE;
    }
    public static _IWireOutcome create_Success(PortableWrapper._IWireValue @value) {
      return new WireOutcome_Success(@value);
    }
    public static _IWireOutcome create_Refusal(Dafny.ISequence<Dafny.Rune> code, Dafny.ISequence<Dafny.Rune> locus, Dafny.ISequence<PortableWrapper._IWireDetail> details) {
      return new WireOutcome_Refusal(code, locus, details);
    }
    public bool is_Success { get { return this is WireOutcome_Success; } }
    public bool is_Refusal { get { return this is WireOutcome_Refusal; } }
    public PortableWrapper._IWireValue dtor_value {
      get {
        var d = this;
        return ((WireOutcome_Success)d)._value;
      }
    }
    public Dafny.ISequence<Dafny.Rune> dtor_code {
      get {
        var d = this;
        return ((WireOutcome_Refusal)d)._code;
      }
    }
    public Dafny.ISequence<Dafny.Rune> dtor_locus {
      get {
        var d = this;
        return ((WireOutcome_Refusal)d)._locus;
      }
    }
    public Dafny.ISequence<PortableWrapper._IWireDetail> dtor_details {
      get {
        var d = this;
        return ((WireOutcome_Refusal)d)._details;
      }
    }
    public abstract _IWireOutcome DowncastClone();
  }
  public class WireOutcome_Success : WireOutcome {
    public readonly PortableWrapper._IWireValue _value;
    public WireOutcome_Success(PortableWrapper._IWireValue @value) : base() {
      this._value = @value;
    }
    public override _IWireOutcome DowncastClone() {
      if (this is _IWireOutcome dt) { return dt; }
      return new WireOutcome_Success(_value);
    }
    public override bool Equals(object other) {
      var oth = other as PortableWrapper.WireOutcome_Success;
    ...
    public override string ToString() {
      string s = "PortableWrapper.WireOutcome.Success";
      s += "(";
      s += Dafny.Helpers.ToString(this._value);
      s += ")";
      return s;
  ...
  public class WireOutcome_Refusal : WireOutcome {
    public readonly Dafny.ISequence<Dafny.Rune> _code;
    public readonly Dafny.ISequence<Dafny.Rune> _locus;
    public readonly Dafny.ISequence<PortableWrapper._IWireDetail> _details;
    public WireOutcome_Refusal(Dafny.ISequence<Dafny.Rune> code, Dafny.ISequence<Dafny.Rune> locus, Dafny.ISequence<PortableWrapper._IWireDetail> details) : base() {
      this._code = code;
      this._locus = locus;
    ...
    public override _IWireOutcome DowncastClone() {
      if (this is _IWireOutcome dt) { return dt; }
      return new WireOutcome_Refusal(_code, _locus, _details);
    }
    public override bool Equals(object other) {
      var oth = other as PortableWrapper.WireOutcome_Refusal;
      return oth != null && object.Equals(this._code, oth._code) && object.Equals(this._locus, oth._locus) && object.Equals(this._details, oth._details);
    }
    public override int GetHashCode() {
      ulong hash = 5381;
      hash = ((hash << 5) + hash) + 1;
      hash = ((hash << 5) + hash) + ((ulong)Dafny.Helpers.GetHashCode(this._code));
      hash = ((hash << 5) + hash) + ((ulong)Dafny.Helpers.GetHashCode(this._locus));
      hash = ((hash << 5) + hash) + ((ulong)Dafny.Helpers.GetHashCode(this._details));
      return (int) hash;
    }
    public override string ToString() {
      string s = "PortableWrapper.WireOutcome.Refusal";
      s += "(";
      s += this._code.ToVerbatimString(true);
      s += ", ";
      s += this._locus.ToVerbatimString(true);
      s += ", ";
      s += Dafny.Helpers.ToString(this._details);
      s += ")";
      return s;
    }
  }
} // end of namespace PortableWrapper
namespace _module {
