module Candidate {
  ...
  lemma L000(p000: S000, n: int)
    requires Q000(p000) && 0 <= n <= |p000|
    ensures StrictAnd(((P000(p000, n) as int) == PrefixSumI64(p000, n as I64 as int)), StrictAnd((0 <= (P000(p000, n) as int)), ((P000(p000, n) as int) <= SumI64(p000))))
    decreases n
  {
    E000(p000, n);
    PrefixSumBounds(p000, n);
    G000(p000, n);
    if n == 0 {
      assert StrictAnd(((P000(p000, 0) as int) == PrefixSumI64(p000, 0 as I64 as int)), StrictAnd((0 <= (P000(p000, 0) as int)), ((P000(p000, 0) as int) <= SumI64(p000))));
    } else {
      L000(p000, n - 1);
      assert StrictAnd(((P000(p000, n) as int) == PrefixSumI64(p000, n as I64 as int)), StrictAnd((0 <= (P000(p000, n) as int)), ((P000(p000, n) as int) <= SumI64(p000))));
    }
  }
    ...
    ensures (result as int) == P000(p000, |p000|)
  {
    ...
    while i000 < |p000|
      ...
      invariant StrictAnd(((v001 as int) == PrefixSumI64(p000, i000 as I64 as int)), StrictAnd((0 <= (v001 as int)), ((v001 as int) <= SumI64(p000))))
      decreases |p000| - i000
    {
      G000(p000, i000 + 1);
