module Candidate {
    ...
    ensures result == P000(p000, p001, |p000|)
  {
    var v000: S000 := [];
    var v001: I64 := 0;
    var v002: R000 := C000(v000, v001);
    assert p000 == p000;
    assert v002 == C000([], p001);
    assert p001 == p001;
    var v003: R000 := v002;
    var i000: int := 0;
    L000(p000, p001, 0);
    while i000 < |p000|
      ...
      invariant p000 == p000 && v002 == C000([], p001)
      invariant p001 == p001
      invariant v003 == P000(p000, p001, i000)
      invariant StrictAnd(((|v003.R000F000| as I64) == i000 as I64), StrictAnd((0 <= v003.R000F001), StrictAnd((v003.R000F001 <= v002.R000F001), (p001 == v002.R000F001))))
      decreases |p000| - i000
    {
      var v004: S000 := v003.R000F000;
      var v005: I64 := v003.R000F001;
      var v006: bool := p000[i000] <= v005;
      var v007: I64 := 0;
      var v008: I64;
      if v006 {
        v008 := p000[i000];
      ...
      assert |v004| < 256;
      var v009: S000 := v004 + [v008];
      assert -9223372036854775808 <= (v005 as int) - (v008 as int) <= 9223372036854775807;
      var v010: I64 := v005 - v008;
      var v011: R000 := C000(v009, v010);
      v003 := v011;
      i000 := i000 + 1;
      L000(p000, p001, i000);
      assert v003 == P000(p000, p001, i000);
    }
    result := v003;
  }
}
